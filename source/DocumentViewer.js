	...
	components:[
		...
		{style:"z-index:2; position:relative;", components:[
			{kind:"onyx.MoreToolbar", components:[
				{kind:"onyx.InputDecorator", fit:true, style:"min-width:200px", unmoveable:true, components:[
				...
				{name:"saveButton", kind:"onyx.Button", classes:"onyx-affirmative", content:"Save", unmoveable:true, ontap:'saveDocument', disabled:true}
			]}
		]}
	],
